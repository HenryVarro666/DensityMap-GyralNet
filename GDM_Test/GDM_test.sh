...
###
 ...
 # @LastEditTime: 2024-07-01 03:45:36
 # @FilePath: /DensityMap-GyralNet/GDM_Test/GDM_test.sh
### 
...
process_folder() {
    ...
    # Run gyralnet.py
    python3 /home/lab/Documents/HCP_data/gyralnet.py --root_dir="$PWD" --subject_list_start_id="$subject_id" --subject_list_end_id="$((subject_id + 1))" --input_dir="${subject_id}_recon" 
