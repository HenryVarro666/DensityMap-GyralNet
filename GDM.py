...
def main(args):
    ...
    for subject in current_subject_list:
        ...
        for sphere in sphere_list:
            ...
            updated_sulc_data, original_sulc_data, curv_data_delete_thicknessZero = initialize_sulc_data(sphere_polydata,
                                                                                                         surf_polydata,
                                                                                                         feature_file_dict,
            ...
            find_skelenton_missing(sphere_polydata, surf_polydata, skeleton_polydata, curv_data_delete_thicknessZero,
                                   original_sulc_data,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-out_dir', '--out_dir', type=str, default='gyralnet_island_GDM1', help='out dir within each subject')
